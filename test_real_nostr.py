...
def create_test_event():
    ...
    content = "Hello Mercury Relay! This is a test note from Python."
...
def test_mercury_relay():
    """Test connection to Mercury Relay"""
        ...
        if "101 Switching Protocols" in response:
            ...
            try:
                ...
                if response:
                    ...
                    print("No response received (this is normal for some relays)")
